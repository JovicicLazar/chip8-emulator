...
void Chip8::OP_Dxyn() {
	...
	uint8_t xPos   		   = this->registers[ Vx ] % VIDEO_WIDTH;  // wrap x if it goes out of the screen
	uint8_t yPos   		   = this->registers[ Vy ] % VIDEO_HEIGHT; // wrap y if it goes out of the screen
	this->registers[ 0xF ] = 0;
